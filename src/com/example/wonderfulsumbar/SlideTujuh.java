...
public class SlideTujuh extends BaseAdapter {
	
	private Context context;

	// array of integers for images IDs
	private Integer[] gambarMenu = { R.drawable.singkarakk1, R.drawable.singkarakk2,
			R.drawable.singkarakk3, };
	
	public SlideTujuh(Context c) {
		context = c;
	}
